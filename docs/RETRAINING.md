...
El modelo vigente se identifica en [MODEL_CARD.md](MODEL_CARD.md). Su reemplazo exige mejorar la validación real con el mismo método y revisar las clases prioritarias.
